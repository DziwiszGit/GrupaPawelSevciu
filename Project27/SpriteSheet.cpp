...
//
//SpriteSheet::SpriteSheet(wchar_t* wpisz, Graphics* gfx)
//{
//	this->gfx = gfx;
//	bmp = NULL;
//	HRESULT hrW;
...
//	hrW = wicFactory->CreateDecoderFromFilename(
//		wpisz,
//		NULL,
//		GENERIC_READ,
...
//	hrW = wicDecoder->GetFrame(0, &wicFrame);
//
//	IWICFormatConverter* wicConverter = NULL;
//	hrW = wicFactory->CreateFormatConverter(&wicConverter);
//
//	hrW = wicConverter->Initialize(
//		wicFrame,
